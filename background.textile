...
*(a) Active in local development community
**(a) Agile Philly
**(a) BarCamp Philly
**(a) Philly CocoaHeads
**(a) Philly JUG
**(a) Philly.rb
**(a) NoSql Summer
*(a) Mobile development on multiple platforms including: iOS, and Windows Phone 7
...
*(a) *Development Tools*, Ant, Git, SVN, Eclipse, Hudson, Maven, XCode
*(a) *Frameworks*, iOS, Hibernate, Ruby on Rails, Spring, OSGi, Microsoft Silverlight
